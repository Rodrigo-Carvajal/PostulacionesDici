      ...
      <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
        <q-card class="card-bg text-white flex-center">
          <q-card-section  class="text-h5">
            <span class="text-h5" style="color:black">Solicitudes</span>
          </q-card-section>
          <q-card-section class="text-h6">
            <div class="row text-left">
            <div  class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <span class="text-weight-bolder">Asignatura</span>
                <div>
...
<script>
import { ref } from 'vue'
import ListaSolicitudes from 'src/components/ListaSolicitudes.vue'

export default {
  components: { ListaSolicitudes },
  setup () {
    return {
