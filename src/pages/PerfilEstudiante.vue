          ...
          <q-card-section class="q-pa-sm">
            <q-list class="row">
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input  color="black" label-color="black" dense v-model="user_details.user_name" label="Nombre"/>
                </q-item-section>
              </q-item>
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input  color="black" label-color="black" dense v-model="user_details.email" label="Contraseña"/>
                </q-item-section>
              </q-item>
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input  color="black" label-color="black" dense v-model="user_details.first_name" label="Rut"/>
                </q-item-section>
              </q-item>
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input  color="black" label-color="black" dense v-model="user_details.last_name" label="Telefono"/>
                </q-item-section>
              </q-item>
              <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input  color="black" label-color="black" autogrow dense v-model="user_details.address" label="Correo institucional"/>
                </q-item-section>
              </q-item>
            </q-list>
          </q-card-section>
          <q-card-actions align="right">
            <q-btn flat elevated glossy class=" text-capitalize bg-info text-black">Actualizar información</q-btn>
          </q-card-actions>
        </q-card>
      </div>
